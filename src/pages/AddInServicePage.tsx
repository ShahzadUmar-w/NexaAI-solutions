...
const appAccents = {
  outlook: {
    ...
    cardText: "text-blue-700 dark:text-blue-100",
    iconBox: "border-blue-200 bg-blue-50 text-blue-700 dark:border-blue-300/15 dark:bg-blue-300/10 dark:text-blue-200",
    check: "text-blue-300",
  ...
  excel: {
    ...
    cardText: "text-emerald-700 dark:text-emerald-100",
    iconBox: "border-emerald-200 bg-emerald-50 text-emerald-700 dark:border-emerald-300/15 dark:bg-emerald-300/10 dark:text-emerald-200",
  ...
  word: {
    ...
    pill: "border-sky-200 bg-sky-50 text-sky-700 dark:border-sky-300/20 dark:bg-sky-300/10 dark:text-sky-100",
    icon: "text-sky-700 dark:text-sky-200",
    card: "border-sky-300/15 bg-sky-300/10",
    cardText: "text-sky-700 dark:text-sky-100",
    iconBox: "border-sky-200 bg-sky-50 text-sky-700 dark:border-sky-300/15 dark:bg-sky-300/10 dark:text-sky-200",
    check: "text-sky-300",
  ...
  powerpoint: {
    ...
    pill: "border-orange-200 bg-orange-50 text-orange-700 dark:border-orange-300/20 dark:bg-orange-300/10 dark:text-orange-100",
    icon: "text-orange-700 dark:text-orange-200",
    card: "border-orange-300/15 bg-orange-300/10",
    cardText: "text-orange-700 dark:text-orange-100",
    iconBox: "border-orange-200 bg-orange-50 text-orange-700 dark:border-orange-300/15 dark:bg-orange-300/10 dark:text-orange-200",
